...
const ResetPassword = ({ setReset, setLogin, email, setemail }) => {
                  ...
                  <div>
                    <div className="input-box mb-4 position-relative">
                      <input
                        ...
                        name="newPassword"
                        className={`w-100 py-2 ps-4 rounded-pill transition ${formik.touched.newPassword &&
                    ...
                    <div className="input-box mb-4 position-relative">
                      <input
                        ...
                        name="comPassword"
                        className={`w-100 py-2 ps-4 rounded-pill transition ${formik.touched.comPassword &&
