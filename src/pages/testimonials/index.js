                ...
                <div className='col-lg-6 col-md-8 col-12'>
                    ...
                    <div className='exactly-section'> 
                       ...
                       <div className='exactly-list'>
                        <ul>
                            <li>
                                <h5 className='name-detail'> Gloria Rose
                                    </h5> 
            ...
            <div className='col-lg-12'>
                <div className='form-bg'>
                 <div className='row align-items-center justify-content-center'>
                    ...
                    <div>
                    <h4 class="tried-detail">   Have you tried one of our courses?</h4>
                    ...
                    <form>
                        ...
                        <div className='row align-items-center justify-content-center'>
                            ...
                            <button type="submit" class="custome-subcribes">Submit</button>
