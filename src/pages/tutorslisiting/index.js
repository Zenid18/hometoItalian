        ...
        <div className='col-lg-4  col-md-6 col-12'>
                 <div className='hashim-setion'>
                    <div className='img-section'>
                        <img src={Gsingerashim}className='img-fluid' alt='Ginger Hashim..' />
...
<div className='col-lg-4  col-md-6 col-12'>
                 <div className='hashim-setion'>
                    <div className='img-section'>
                        <img src={Gsingerashima}className='img-fluid' alt='Ginger Hashim..' />
                        <div className='like-section'>
                          <img src={ Like} className='img-fluid' alt='like'/>
                    </div>
                    </div>
        ...
        <div className='col-lg-4  col-md-6 col-12'>
                 <div className='hashim-setion'>
                    <div className='img-section'>
                        <img src={Gsingerashimb}className='img-fluid' alt='Ginger Hashim..' />
                        <div className='like-section'>
                          <img src={ Like} className='img-fluid' alt='like'/>
                    </div>
                    </div>
...
<div className='col-lg-4  col-md-6 col-12'>
                 <div className='hashim-setion'>
                    <div className='img-section'>
                        <img src={Gsingerashimd}className='img-fluid' alt='Ginger Hashim..' />
                        <div className='like-section'>
                          <img src={ Like} className='img-fluid' alt='like'/>
                    </div>
                    </div>
        ...
        <div className='col-lg-4  col-md-6 col-12'>
                 <div className='hashim-setion'>
                    <div className='img-section'>
                        <img src={Gsingerashimes}className='img-fluid' alt='Ginger Hashim..' />
                        <div className='like-section'>
                          <img src={ Like} className='img-fluid' alt='like'/>
                    </div>
                    </div>
...
<div className='container p-0'>
  ...
  <Slider {...settings}>
      ...
      <div className='hashim-setions'>
                    <div className='img-section'>
                        <img src={Slidera}className='img-fluid' alt='Ginger Hashim..' />
      ...
      <div className='hashim-setions'>
                    <div className='img-section'>
                        <img src={Sliderb}className='img-fluid' alt='Ginger Hashim..' />
                        <div className='like-sections'>
                          <img src={ Like} className='img-fluid' alt='like'/>
                    </div>
                    </div>
      ...
      <div className='hashim-setions'>
                    <div className='img-section'>
                        <img src={Sliderc}className='img-fluid' alt='Ginger Hashim..' />
                        <div className='like-sections'>
                          <img src={ Like} className='img-fluid' alt='like'/>
                    </div>
                    </div>
